...
#define MMA_DEVICE_NAME     LSM6DS3_GSENSOR_DEV_PATH
...
#define GSENSOR_IOC_SET_RATE        LSM6DS3_IOC_SET_RATE
#define GYRO_IOC_ENABLE             LSM6DS3_IOC_ENABLE
#define GYRO_IOC_SET_RATE           LSM6DS3_IOC_SET_RATE

#define EVENT_TYPE_ACCEL_X          REL_X
#define EVENT_TYPE_ACCEL_Y          REL_Y
#define EVENT_TYPE_ACCEL_Z          REL_Z
#define EVENT_TYPE_ACCEL_STATUS     REL_WHEEL
