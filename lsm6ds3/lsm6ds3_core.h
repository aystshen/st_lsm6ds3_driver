...
#define INPUT_EVENT_TYPE		EV_REL
#define INPUT_EVENT_X			REL_X
#define INPUT_EVENT_Y			REL_Y
#define INPUT_EVENT_Z			REL_Z
#define INPUT_EVENT_MISC			REL_MISC
#define INPUT_EVENT_TIME_MSB		REL_RX
#define INPUT_EVENT_TIME_LSB		REL_RY
